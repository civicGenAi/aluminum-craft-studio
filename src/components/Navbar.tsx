  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between h-16 md:h-20 px-4">
        ...
        {/* WhatsApp pill + Hamburger */}
        <div className="flex items-center gap-3">
          <a
            href={buildWhatsAppLink(whatsappMessages.quote)}
            target="_blank"
            rel="noopener noreferrer"
            className="hidden sm:inline-flex items-center gap-2 bg-primary text-primary-foreground text-xs font-semibold px-4 py-2 rounded-md hover:bg-accent-hover transition-colors"
          >
            WhatsApp Us
          </a>
          <button
          ...
          >
            <div className="container mx-auto px-4 py-6 flex flex-col gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 bg-primary text-primary-foreground text-center py-3 rounded-md font-semibold min-h-[48px] flex items-center justify-center"
              >
                WhatsApp Us
              </a>
            </div>
